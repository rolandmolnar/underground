...
MapSystem['DragonMountain'].player = {level: 4, weapon: Weapon.get('Dagger_2'), armor: Armor.get('LeatherArmor_2')};
...
MapSystem['DragonMountain'][0].map += 'XX XXX XXX         XXXA     A  X DX';
...
MapSystem['DragonMountain'][0].map += 'XDXXDXXDXX XX   A     A   X X XXXXX';
...
MapSystem['DragonMountain'][0].map += 'X ABFDXX A DX   XX X XXAX X XDXX XX';
